  ...
  return (
    <div className="flex flex-row items-center justify-center h-full">
      <div className="flex flex-col items-center justify-center gap-[5rem] p-10 bg-white rounded-md">
        <h1 className="mb-5 text-4xl">Welcome back</h1>
        <div className="flex flex-col gap-4">
          ...
          <button className="p-2 text-black bg-blue-500 border-2 border-black rounded-md hover:bg-[#ddd] transition-all duration-300" onClick={login}>
            Login
          </button>
        </div>
      </div>
